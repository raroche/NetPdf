...
/// embedder (Phase 1 Task 10). Bytes are exposed as <see cref="ReadOnlyMemory{Byte}"/> so
/// downstream code can read but not mutate the emitted artifacts — accidental mutation
/// would corrupt the subset and is silent.
/// </summary>
/// <remarks>
